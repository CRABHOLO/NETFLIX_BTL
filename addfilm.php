          ...
          <div class="container-fluid" style="background-color: black;">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
              ...
              <form class="d-flex">
                ...
                <button class="btn" type="submit" style="color: red; width: 40px; height: 40px;"><i
                    class="bi bi-search"></i></button>
              </form>
              <button class="btn" type="submit" style="color: red;width: 40px; height: 40px;margin: 5px;"><i
                  class="bi bi-bell"></i></button>
              <button class="btn" type="submit" style="color: red;width: 40px; height: 40px;"><i
                  class="bi bi-person-circle"></i></i></button>
            </div>
          </div>
        </nav>
      </div>
